    ...
    try {
      ...
      window.Eduzz.Checkout.init({
        ...
        onSuccess: () => {
          ...
          // Redirecionamento direto para /obrigado com parâmetros básicos
          const redirectUrl = `https://robertonavarrooficial.com.br/obrigado?produto=${contentId}&valor=${ticket.price}`;
