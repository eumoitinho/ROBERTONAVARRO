      ...
      {isOpen && (
        <div className="bg-white text-black p-4 rounded-lg shadow-lg mb-4 max-w-xs animate-in fade-in slide-in-from-bottom-5 duration-300">
          ...
          <a
            ...
            className="bg-green-500 text-white py-2 px-4 rounded-full text-xs font-medium flex items-center justify-center gap-2 hover:bg-green-600 transition-colors"
          >
