          ...
          {showCountdown && countdownTargetDate ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mt-10 md:mt-0 mb-2 md:mb-4">
              {[
                ...
                <div
                  key={index}
                  className={`bg-zinc-900/50 backdrop-blur border border-zinc-800/50 rounded-xl md:rounded-2xl p-3 md:p-6 transition-all duration-1000 hover:border-red-500/50 hover:-translate-y-1 ${
                    isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
                  }`}
