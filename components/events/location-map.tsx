...
export default function LocationMap({ data }: Props) {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined" && mapRef.current) {
      ...
      iframe.src = data?.mapEmbedUrl || "https://www.google.com/maps/embed?pb=!4v1746647410285!6m8!1m7!1sCmXGf52YxQcnwTU-1MsNlQ!2m2!1d-23.49787817078243!2d-46.85401716676614!3f173.40748254106288!4f0.31314005196917094!5f0.7034732728947808"
      iframe.width = "100%"
      iframe.height = "450"
