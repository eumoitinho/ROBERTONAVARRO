...
const intelligenceTypes = [
  {
    ...
    description: "Domine suas emoções e fortaleça sua confiança para tomar decisões claras e corajosas, mesmo diante de press JARões e incertezas.",
  ...
  },
  {
    ...
    description: "Reescreva sua história com o dinheiro. Supere crenças negativas, aprenda as regras da prosperidade e construa sua segurança financeira com consistência.",
    icon: "/financial-intelligence-icon.png",
    benefits: ["Gestão eficiente de recursos", "Estratégias de investimento", "Planejamento financeiro", "Mentalidade de abundância"],
  },
  {
    title: "Inteligência espiritual",
    description: "Alinhe sua mente e espírito com seu propósito de vida e descubra como viver com mais sentido, leveza e prosperidade.",
  ...
  },
  {
    ...
    description: "Adote o mindset dos empreendedores de sucesso. Saiba como identificar oportunidades, tomar decisões estratégicas e pensar grande, com ousadia e visão de futuro.",
    icon: "/business-intelligence-icon.png",
    benefits: ["Visão estratégica", "Identificação de oportunidades", "Tomada de decisão eficaz", "Liderança inspiradora"],
  },
];
...
const eventHighlights = [
  { title: "Imersão Completa", description: "10 horas de conteúdo transformador em um único dia", icon: "zap" },
  { title: "Material Exclusivo", description: "Apostila digital e recursos para implementação imediata", icon: "file-text" },
  { title: "Networking Qualificado", description: "Conexão com outros profissionais e empreendedores", icon: "users" },
  { title: "Certificado", description: "Documento oficial de participação no evento", icon: "award" },
];
...
export default function CrencasDaRiquezaPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-zinc-950/80 backdrop-blur-md border-b border-zinc-800/50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Button asChild variant="outline" className="border-yellow-500 text-yellow-500 hover:bg-yellow-500/10" size="sm">
      ...
      <HeroPages
        ...
        subtitle="Transformação mental" // Kept from original as it fits
  ...
  {/* Countdown Timer */}
      <div className="relative py-6">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
            ...
            <Button asChild className="bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-semibold rounded-full px-6 py-2 text-sm cta-hover">
              <a href="#form">
      ...
      {/* New Introductory Section - Bloco 3
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">NÃO É SOBRE O QUANTO VOCÊ GANHA… É SOBRE COMO VOCÊ PENSA</h2>
            <p className="text-xl text-zinc-300 mb-8">
              O evento Crenças da Riqueza é uma imersão intensa de 10 horas com o especialista Roberto Navarro, criada para empresários e profissionais que já perceberam que o maior obstáculo para crescer financeiramente está dentro da própria mente.
            </p>
            <p className="text-xl text-zinc-300 mb-8">
              Durante um dia inteiro, você vai mergulhar em conceitos de inteligência emocional, financeira, espiritual e empresarial para reprogramar a forma como pensa, sente e age em relação ao dinheiro.
            </p>
            <p className="text-xl text-zinc-300 mb-8">
              Esta não é uma formação comum. É uma virada de chave. Você sairá dessa imersão com uma nova visão sobre prosperidade e munido(a) de ferramentas mentais precisas para acessar o próximo nível da sua vida pessoal e profissional.
            </p>
            <Button asChild size="lg" className="bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-semibold rounded-full px-8 py-6 text-lg cta-hover">
              <a href="#form">
                QUERO PARTICIPAR AGORA! <ArrowRight className="ml-2 h-5 w-5" />
              </a>
            </Button>
          </div>
        </div>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-4 px-4 py-1 border-yellow-500/50 bg-yellow-500/5">DESAFIOS</Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">O QUE ESTÁ TE <span className="text-yellow-400">IMPEDINDO DE PROSPERAR</span> ESTÁ DENTRO DE VOCÊ</h2>
            <p className="text-zinc-300 max-w-3xl mx-auto">Identifique os bloqueios mentais que estão limitando seu crescimento financeiro</p>
          </div>
