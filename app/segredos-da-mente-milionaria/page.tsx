...
export default function SegredosDaMenteMilionaria() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch("/api/registrations", {
        method: "POST",
        body: JSON.stringify({
          eventId: 6, // ID do evento "Segredos da Mente Milionária"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/50 rounded-3xl p-6 relative overflow-hidden">
                ...
                <Image
                  src="https://robertonavarrooficial.com.br/wp-content/uploads/2024/03/Independencia-Financeira-Roberto-Navarro-1.webp"
          ...
          <div className="bg-gradient-to-r from-zinc-900 to-zinc-800 p-8 rounded-xl border border-zinc-700">
            ...
            <div className="mt-8 text-center">
              <GlowEffect>
                <Button
                  asChild
                  className="cta-hover bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black text-base font-bold py-4 px-8 rounded-full"
                >
                  <Link href="#cadastro">GARANTIR MINHA VAGA AGORA</Link>
                </Button>
              </GlowEffect>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              >
                <Link href="#cadastro">QUERO PARTICIPAR AGORA! <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mt-12">
            <Button
              ...
              className="cta-hover bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-semibold rounded-full px-8 py-4 text-base"
            >
              <Link href="#cadastro">QUERO APRENDER ESSES SEGREDOS <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/50 rounded-xl p-6 hover:border-yellow-400 transition-all duration-300 hover:-translate-y-1">
                  <p className="text-zinc-300">
                    Quando você não tem um propósitoito definido, a vida se torna uma rotina de distrações. A
              ...
              <Button
                ...
                className="cta-hover bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-semibold rounded-full px-8 py-4 text-base"
              >
                <Link href="#cadastro">QUERO ENCONTRAR MEU PROPÓSITO <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
            </div>
          </div>
        </div>
  ...
  <section className="py-20 relative">
    ...
    <div className="container mx-auto px-4 relative z-10">
      <div className="text-center mb-16">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Perguntas que <span className="text-yellow-400">os milionários fazem</span> e que você precisa começar a fazer
        </h2>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          <div className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 rounded-xl p-6 hover:border-yellow-400 transition-all duration-300 hover:-translate-y-1">
            ...
            <p className="text-zinc-300">
              Milionários não acumulam só dinheiro, eles resolvem problemas reais. Quanto maior o impacto gerado, maior
    ...
    <div className="container mx-auto px-4 relative z-10">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
        <div className="bg-gradient-to-b from-zinc-800/50 to-zinc-900/50 backdrop-blur-sm border border-zinc-700/30 rounded-2xl p-8 hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-yellow-500/10">
          ...
          <p className="text-zinc-300">
            Veja o mundo como um campo de oportunidades. Desenvolva visão estratégica e atitude empreendedora, mesmo que
            você ainda não tenha um negócio.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-b from-zinc-800/50 to-zinc-900/50 backdrop-blur-sm border border-zinc-700/30 rounded-2xl p-8 hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-yellow-500/10">
          ...
          <p className="text-zinc-300">
            Aprenda a controlar o fluxo do seu dinheiro. Identifique entradas, elimine desperdícios e faça seu capital
        ...
        <div className="bg-gradient-to-b from-zinc-800/50 to-zinc-900/50 backdrop-blur-sm border border-zinc-700/30 rounded-2xl p-8 hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-yellow-500/10">
          ...
          <p className="text-zinc-300">
            Milionários não tomam decisões baseadas no medo. Aprenda a controlar emoções, lidar com a pressão e manter o
            foco em momentos críticos.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-b from-zinc-800/50 to-zinc-900/50 backdrop-blur-sm border border-zinc-700/30 rounded-2xl p-8 hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-yellow-500/10">
          ...
          <p className="text-zinc-300">
            Conecte prosperidade com propósito. Alinhe o que você faz com quem você é e deixe que o universo conspire a
            favor do seu crescimento.
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div className="bg-zinc-900/80 backdrop-blur-sm border border-zinc-800/50 rounded-3xl p-8 relative overflow-hidden hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-yellow-500/10">
          ...
          <div className="flex flex-col items-center">
            ...
            >
              <Link href="#inscricao">EU QUERO!</Link>
            </Button>
          </div>
        </div>
  ...
  ;<section id="inscricao" className="py-20 relative">
    ...
    <div className="container mx-auto px-4 relative z-10">
      <div className="text-center mb-16">
        <div className="inline-flex items-center gap-2 bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 rounded-full py-2 px-4 mb-4">
          <span className="text-sm font-medium">INSCREVA-SE AGORA E GARANTA SUA VAGA!</span>
        </div>
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Preencha o formulário abaixo para participar</h2>
      </div>

      <div className="max-w-md mx-auto bg-zinc-900/80 backdrop-blur-sm border border-zinc-800/50 rounded-3xl p-8 relative overflow-hidden hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-2">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-yellow-400 to-amber-500"></div>
        {error && (
        ...
        <div className="bg-zinc-900/80 backdrop-blur-sm border border-zinc-800/50 rounded-3xl p-8 relative overflow-hidden hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-2">
          ...
          <div className="mt-8 p-6 bg-zinc-800/50 rounded-xl border border-zinc-700/50">
            ...
            <Button
              ...
              className="cta-hover w-full bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-semibold rounded-xl py-4 text-base"
            >
              <Link href="#inscricao">GARANTA SEU LUGAR AGORA!</Link>
            </Button>
          </div>
        </div>
      </div>
