  ...
  try {
    ...
    const robertoNavarro = await payload.create({
      ...
      data: {
        ...
        bio: 'Roberto Navarro é um dos maiores especialistas em educação financeira do Brasil.',
        achievements: [
    ...
    await payload.create({
      ...
      data: {
        ...
        description: 'Descubra os segredos milenares que transformam pessoas comuns em milionárias.',
        price: 49.90,
        seo: {
