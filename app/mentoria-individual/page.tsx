    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      >
        <div className="inline-flex items-center gap-2 bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 rounded-full py-2 px-4 mb-6">
          ...
          <span className="text-sm font-medium">Mentoria Individual Exclusiva</span>
        </div>
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-500">
            Transforme sua vida
          </span>{" "}
          com a mentoria mais exclusiva do Brasil
        </h1>
        <p className="text-lg text-zinc-300 mb-4 max-w-xl">
          A Mentoria Individual com Roberto Navarro é o caminho para quem busca resultados extraordinários em finanças, emoções e propósito.
        </p>
        <p className="text-md text-zinc-400 mb-8 max-w-xl">
          Um acompanhamento 100% personalizado para destravar seu potencial e alcançar liberdade financeira com equilíbrio.
        </p>
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400">
              <span className="text-white font-medium">+500</span> mentorados transformados
            </p>
          </div>
        </div>
      </div>
...
<div className="container mx-auto px-4 relative z-10">
  <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20">
    {[
      ...
      { icon: <Zap className="h-6 w-6 text-yellow-400" />, value: "6 meses", label: "Acompanhamento" },
      { icon: <Brain className="h-6 w-6 text-yellow-400" />, value: "100%", label: "Personalização" },
    ].map((stat, index) => (
      <div
        key={index}
...
<section id="inscricao" className="py-20 relative">
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="max-w-2xl mx-auto bg-zinc-900/80 backdrop-blur-sm border border-zinc-800/50 rounded-3xl p-8 relative overflow-hidden hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-yellow-500/10 text-center">
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-yellow-400 to-amber-500"></div>
      <h2 className="text-3xl md:text-4xl font-bold mb-6 text-yellow-400">Garanta sua vaga na Mentoria Individual</h2>
      <p className="text-lg mb-4 text-zinc-300">Investimento: R$ 25.000,00</p>
      <p className="text-md mb-8 text-zinc-300">Vagas limitadas para quem está pronto para uma transformação completa.</p>
      <Button
        asChild
