          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-zinc-300 mb-4 max-w-xl">
                A Mentoria Individual com Roberto Navarro é o caminho para quem busca resultados extraordinários em
                finanças, emoções e propósito.
              </p>
              <p className="text-md text-zinc-400 mb-8 max-w-xl">
                Um acompanhamento 100% personalizado para destravar seu potencial e alcançar liberdade financeira com
                equilíbrio.
              </p>
