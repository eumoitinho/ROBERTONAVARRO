  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
      ...
      <p className="text-lg text-zinc-300 mb-8 max-w-3xl">
        O LCF Mentoring PRO reúne os treinamentos mais transformadores do educador financeiro Roberto Navarro em um único programa - criado para te colocar no seleto grupo de pessoas que vivem com consciência, riqueza e propósito.
      </p>
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        <Button asChild className="cta-hover bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-semibold rounded-full px-8 py-6 text-base">
          <Link href="#cadastro">CONQUISTE SUA VAGA!</Link>
        </Button>
      ...
      <div className="flex items-center gap-6">
        <div className="flex -space-x-2">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="w-10 h-10 rounded-full border-2 border-zinc-900 bg-gradient-to-br from-yellow-200 to-amber-500 flex items-center justify-center text-black font-bold text-xs">{i}</div>
          ))}
        </div>
        <div>
          ...
          <p className="text-sm text-zinc-400"><span className="text-white font-medium">130,000+</span> vidas transformadas</p>
        </div>
      </div>
    </div>
  </div>
...
<div className="container mx-auto px-4 relative z-10">
  <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-20">
    {[
      ...
      <div key={index} className={`bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/50 rounded-2xl p-6 transition-all duration-1000 hover:border-yellow-500/50 hover:-translate-y-1 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`} style={{ transitionDelay: `${500 + index * 100}ms` }}>
        <div className="flex items-center gap-4">
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="text-center mb-16">
      ...
      <h2 className="text-3xl md:text-4xl font-bold mb-4">
        A RIQUEZA COMEÇA COM CLAREZA.<br className="hidden md:block" />
      ...
      <div className="w-full lg:w-1/2 space-y-8">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-zinc-950/80 rounded-2xl p-6 border border-zinc-800/60 shadow-lg">
            ...
            <p className="text-zinc-300 text-base">
              Desenvolva inteligência financeira aplicada, aprenda a investir com segurança, trabalhe sua mentalidade de alta performance e encontre clareza sobre seu propósito de vida.
            </p>
          </div>
        </div>
        <div className="bg-zinc-950/80 rounded-2xl p-6 border border-zinc-800/60 shadow-lg">
          ...
          <p className="text-zinc-300 text-base">
            Conteúdos de alto nível, encontros presenciais e um ecossistema de suporte contínuo. O programa foi desenhado para levar você do ponto em que está hoje até o estilo de vida que realmente merece viver — com liberdade, consciência e domínio completo sobre sua jornada.
          </p>
        </div>
        <div>
          <Button asChild className="cta-hover bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-semibold rounded-full px-8 py-4 text-base mt-4">
            <Link href="#cadastro">CONQUISTE SUA VAGA! <ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex justify-center mb-8 lg:mb-0">
        <div className="relative max-w-md w-full">
          ...
          <div className="bg-zinc-900/70 backdrop-blur-sm border border-zinc-800/50 rounded-3xl p-4 relative overflow-hidden hover:border-yellow-400 transition-all duration-300 hover:-translate-y-2 shadow-2xl">
            ...
            <Image
              src="/placeholder.svg?height=500&width=600&query=financial mentoring session professional"
...
<section id="o-que-aprender" className="py-20 relative">
  <div className="container mx-auto px-4 relative z-10">
    ...
    <div className="grid md:grid-cols-2 gap-8">
      {[
        { icon: <BarChart className="h-6 w-6" />, title: "Inteligência emocional", desc: "Domine suas emoções e padrões mentais, desenvolvendo resiliência, clareza e foco para tomar decisões consistentes em qualquer área da vida." },
        { icon: <DollarSign className="h-6 w-6" />, title: "Inteligência financeira", desc: "Destrave suas crenças limitantes e aprenda a organizar, direcionar e multiplicar seus recursos com consciência e consistência." },
        { icon: <Award className="h-6 w-6" />, title: "Inteligência espiritual", desc: "Conecte sua jornada material com seu propósito de vida. Viver com significado não é um luxo - é a base para prosperar com equilíbrio." },
        { icon: <Target className="h-6 w-6" />, title: "Inteligência estratégica", desc: "Alinhe carreira, investimentos, rotina e hábitos com um plano de ação realista e poderoso." },
      ].map((module, index) => (
        <div key={index} className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/50 rounded-xl p-6 hover:border-yellow-400 transition-all duration-300 hover:-translate-y-2">
          <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-yellow-400 to-amber-600 rounded-2xl flex items-center justify-center text-black mb-4">{module.icon}</div>
    ...
    <div className="grid md:grid-cols-2 gap-16 items-center">
      <div className="relative">
        ...
        <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/50 rounded-3xl p-6 relative overflow-hidden hover:border-yellow-400 transition-all duration-300 hover:-translate-y-2">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-yellow-400 to-amber-500"></div>
          <Image src="/placeholder.svg?height=300&width=300&query=professional financial mentor" alt="Roberto Navarro" width={300} height={300} className="w-full h-auto object-contain hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
    ...
    <div className="grid md:grid-cols-3 gap-8">
      {[
        ...
        <div key={index} className="aspect-video rounded-lg overflow-hidden">
          <iframe width="100%" height="100%" src={video.src} title={video.title} style={{ border: 0 }} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="w-full h-full object-cover"></iframe>
        </div>
      ))}
    </div>
    <div className="text-center mt-12">
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="max-w-2xl mx-auto">
        ...
        {[
      {
        ...
        answer: (
          <>
            <span className="block mb-2">Não! O programa é para quem deseja transformar sua vida pessoal e profissional.</span>
            <span className="block">Você pode aplicar os conhecimentos em sua vida ou, se quiser, transformar isso em uma carreira de impacto.</span>
          </>
        ),
      },
          {
            ...
            answer: (
              <>
                <span className="block mb-2">Sim! São <b>4 imersões presenciais</b> em datas estratégicas.</span>
          ...
          },
          {
            ...
            answer: (
              <>
                <span className="block mb-2">O PRO une os treinamentos mais poderosos do Navarro com acompanhamento real, experiência imersiva e aplicação prática.</span>
                <span className="block">É a experiência mais completa para quem busca transformação de verdade.</span>
              </>
            ),
          },
          {
            ...
            answer: (
              <>
                ...
                <span className="block">Nos primeiros 30 dias você já terá clareza e ações estruturadas. Em 6 meses, os resultados serão visíveis.</span>
              </>
            ),
          },
        ].map((faq, index) => (
          <AccordionItem key={index} value={`item-${index}`} className="bg-zinc-900/80 border border-zinc-800/60 rounded-xl">
      ...
      <div className="text-center mt-8">
        <Button asChild className="cta-hover bg-yellow-500/90 hover:bg-yellow-600 text-black font-semibold rounded-full px-8 py-4 text-base">
...
<section className="py-20 relative overflow-hidden">
        ...
        <ul className="space-y-3 mb-8 text-zinc-300 text-base">
          <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-yellow-400 mt-1" />Acesso vitalício aos principais treinamentos</li>
          <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-yellow-400 mt-1" />4 imersões presenciais intensivas</li>
          <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-yellow-400 mt-1" />Mais de 100h de conteúdo prático</li>
          <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-yellow-400 mt-1" />Suporte direto e acompanhamento</li>
          <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-yellow-400 mt-1" />Garantia de 6 meses: <br/> Se sua vida não mudar, devolvemos seu dinheiro</li>
        </ul>
            ...
            <div>
              ...
              <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-yellow-400 mt-1" />Networking com alunos de alto nível</li>
            <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-yellow-400 mt-1" />Comunidade exclusiva</li>
            <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-yellow-400 mt-1" />Mentorias ao vivo e acompanhamento</li>
            <li className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-yellow-400 mt-1" />Material complementar e ferramentas práticas</li>
          ...
          <Link href="#cadastro">QUERO ENTRAR PARA O LCF PRO</Link>
        </Button>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            <div>
              ...
              <p className="text-sm text-zinc-400 mb-4">
                Transformando carreiras no mercado financeiro desde 2015.
              </p>
