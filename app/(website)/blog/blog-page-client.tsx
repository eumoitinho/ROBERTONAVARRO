      ...
      <section className="py-24 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-amber-600">
                TRANSFORMAR SUA MENTE E NEGÓCIOS
              </span>
            </h1>
              ...
              {filteredPosts.map((post: BlogPost) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-zinc-300 mb-4 line-clamp-3 leading-relaxed">{post.excerpt}</p>
          ...
          <section id="newsletter" className="mt-20 bg-gradient-to-r from-zinc-900 via-zinc-800 to-zinc-900 rounded-3xl p-12 text-center border border-zinc-700/50">
            <h3 className="text-3xl md:text-4xl font-bold mb-4">RECEBA INSIGHTS EXCLUSIVOS</h3>
            ...
            <div className="max-w-md mx-auto">
              ...
              <p className="text-xs text-zinc-500 mt-4">Você pode cancelar a inscrição a qualquer momento. Sem spam.</p>
            </div>
          </section>
        </div>
      </section>
