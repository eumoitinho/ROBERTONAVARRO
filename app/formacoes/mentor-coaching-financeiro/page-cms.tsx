...
export default function MentorCoachingFinanceiroPageCMS() {
  ...
  useEffect(() => {
    ...
    const fetchFormationData = async () => {
      try {
        const data = await getFormation('mentor-coaching-financeiro')
  ...
  const formationTitle = formationData?.title || "Transformamos profissionais em verdadeiros geradores da riqueza"
  const formationSubtitle = formationData?.subtitle || "MENTOR COACHING FINANCEIRO"
  const formationDescription = formationData?.description || "Aprenda a instalar a inteligência financeira na sua vida e aumentar sua renda, com estratégias comprovadas."
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      {/* [Bloco 1] Hero Section - LAYOUT ORIGINAL COM DADOS DO SANITY */}
        ...
        <div className="container mx-auto px-4 relative z-10 flex flex-col justify-center">
          <ScrollAnimation animation="fadeInUp" className="max-w-4xl mx-auto text-center">
            <Badge variant="outline" className="mb-6 px-4 py-2 border-yellow-500/50 bg-yellow-500/5">
              <span className="text-sm font-medium">{formationSubtitle}</span>
            </Badge>

            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight">
              {formationTitle.split(' ').slice(0, 2).join(' ')}{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-amber-600">
                {formationTitle.split(' ').slice(2, 6).join(' ')}
              </span>{" "}
              {formationTitle.split(' ').slice(6).join(' ')}
            </h1>
      ...
      {/* [Bloco 2] Seção Mentor - IDÊNTICA AO ORIGINAL */}
      ...
      {/* [Bloco 3] A Armadilha Invisível - IDÊNTICA AO ORIGINAL */}
      ...
      {/* [Bloco 3] Sobre a Metodologia - IDÊNTICA AO ORIGINAL */}
      ...
      {/* [Bloco 4] O Que Você Aprenderá - IDÊNTICA AO ORIGINAL */}
      <section className="py-20 bg-zinc-900/30">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeInUp" className="text-center mb-16">
            <Badge variant="outline" className="mb-4 px-4 py-2 border-yellow-500/50 bg-yellow-500/5">
      ...
      {/* [Bloco 5] Para Quem é o Treinamento - IDÊNTICA AO ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeInUp" className="text-center mb-16">
            <Badge variant="outline" className="mb-4 px-4 py-2 border-yellow-500/50 bg-yellow-500/5">
      ...
      {/* [Bloco 6] Sobre Roberto Navarro - IDÊNTICA AO ORIGINAL */}
      <section className="py-20 bg-zinc-900/30">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeIn">
      ...
      {/* [Bloco 7] O Que Esperar - IDÊNTICA AO ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeInUp" className="text-center mb-16">
            <Badge variant="outline" className="mb-4 px-4 py-2 border-yellow-500/50 bg-yellow-500/5">
      ...
      {/* [Bloco 8] Garantia - IDÊNTICA AO ORIGINAL */}
      <section className="py-20 bg-zinc-900/30">
        <div className="container mx-auto px-4">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="bg-zinc-900/90 border-2 border-yellow-500/40 rounded-3xl p-10 text-center">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-zinc-300">
                    <li className="flex items-start gap-2">
                      ...
                      <span>3 dias de mentoria intensiva</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-yellow-400 mt-0.5 flex-shrink-0" />
                      <span>Reprogramação mental financeira</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-yellow-400 mt-0.5 flex-shrink-0" />
              ...
              >
                <a href={ctaLink}>
                  GARANTIR MINHA VAGA AGORA <ArrowRight className="ml-3 h-6 w-6" />
                </a>
              </Button>

              <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-xl">
                <p className="text-yellow-400 font-bold">🔥 Turma com vagas limitadas!</p>
                <p className="text-zinc-300 text-sm mt-1">Garanta sua vaga e transforme sua vida financeira</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* [Bloco 9] 3 Caminhos - IDÊNTICA AO ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeInUp" className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
      ...
      {/* [Bloco 10] FAQ - IDÊNTICA AO ORIGINAL */}
      <section className="py-20 bg-zinc-900/30">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeInUp" className="text-center mb-16">
            <Badge variant="outline" className="mb-4 px-4 py-2 border-yellow-500/50 bg-yellow-500/5">
      ...
      {/* Testimonials Section - IDÊNTICA AO ORIGINAL */}
      <TestimonialsSection />

      {/* Footer - IDÊNTICO AO ORIGINAL */}
      <Footer />

      {/* WhatsApp Button - IDÊNTICO AO ORIGINAL */}
