...
export default function MentoriaDeInvestimentosPageCMS() {
  ...
  useEffect(() => {
    ...
    const fetchFormationData = async () => {
      try {
        const data = await getFormation('mentoria-de-investimentos')
  ...
  const formationTitle = formationData?.title || "MENTORIA DE INVESTIMENTOS"
  const formationSubtitle = formationData?.subtitle || "Faça seu dinheiro trabalhar por você"
  const formationDescription = formationData?.description || "Formação prática para quem quer aprender a investir com segurança, confiança e estratégias reais do mercado."
  const formationSecondTitle = formationData?.secondTitle || "Transforme sua vida financeira com a mentoria de investimentos"
  const formationPrice = formationData?.price?.value ? `R$ ${formationData.price.value.toLocaleString('pt-BR')}` : "R$ 3.997"
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      {/* Bloco 2 - Reprograme sua mente - LAYOUT ORIGINAL */}
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {/* Caixinha vermelha - IDÊNTICA AO ORIGINAL */}
            ...
            {/* Caixinha verde - IDÊNTICA AO ORIGINAL */}
      ...
      {/* Bloco 3 - A mentoria que vai transformar - LAYOUT ORIGINAL */}
      <section className="py-20 relative">
      ...
      {/* Bloco 4 - O que você vai aprender - LAYOUT ORIGINAL */}
      ...
      {/* Bloco 5 - Investir não é aposta - LAYOUT ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
      ...
      {/* Bloco 6 - Aprenda com o mentor - LAYOUT ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
      ...
      {/* Bloco 7 - Transformações - LAYOUT ORIGINAL */}
      ...
      {/* Bloco 8 - Investimento seguro - LAYOUT ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 rounded-full py-2 px-4 mb-4">
      ...
      {/* Bloco 9 - Perguntas frequentes - LAYOUT ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="bg-zinc-900/90 border-2 border-yellow-500/40 rounded-3xl p-10 text-center">
              ...
              <p className="text-zinc-300 mb-6">ou 12x de R$ 397</p>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-zinc-300">
                    <li className="flex items-start gap-2">
                      ...
                      <span>2 dias de mentoria presencial</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-yellow-400 mt-0.5 flex-shrink-0" />
                      <span>Acesso 1 ano à Universidade do Investidor</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-yellow-400 mt-0.5 flex-shrink-0" />
                      <span>Material completo e ferramentas</span>
                    </li>
                  </ul>
                </div>
                <div>
              ...
              <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-xl">
                <p className="text-yellow-400 font-bold">🔥 Vagas Limitadas!</p>
                <p className="text-zinc-300 text-sm mt-1">Apenas 50 vagas disponíveis para a próxima turma</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Footer simplificado sem links - IDÊNTICO AO ORIGINAL */}
