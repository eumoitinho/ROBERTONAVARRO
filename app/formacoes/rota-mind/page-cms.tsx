...
export default function RotaMindPageCMS() {
  ...
  useEffect(() => {
    ...
    const fetchFormationData = async () => {
      try {
        const data = await getFormation('rota-mind')
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-800 text-white relative overflow-x-hidden">
      ...
      {/* Challenges Section - IDÊNTICA AO ORIGINAL */}
      ...
      {/* What Is Section - IDÊNTICA AO ORIGINAL */}
      ...
      {/* Event Highlights - IDÊNTICA AO ORIGINAL */}
      ...
      {/* Benefits Section - IDÊNTICA AO ORIGINAL */}
      ...
      {/* Advisory Section - IDÊNTICA AO ORIGINAL */}
      <section className="py-24 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-zinc-950/95 to-zinc-900/95"></div>
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-blue-500/30 to-transparent"></div>
        <div className="container mx-auto px-4 relative z-10">
      ...
      {/* Mentor Section - IDÊNTICA AO ORIGINAL */}
      ...
      {/* Form Section - IDÊNTICA AO ORIGINAL */}
      ...
      {/* FAQ Section - IDÊNTICA AO ORIGINAL */}
      <section className="py-24 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-zinc-900/95 to-zinc-950/95"></div>
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-blue-500/30 to-transparent"></div>
        <div className="container mx-auto px-4 relative z-10">
      ...
      {/* Final CTA - IDÊNTICA AO ORIGINAL */}
      <section className="py-20 relative">
