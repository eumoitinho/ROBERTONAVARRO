...
export default function MetodoTFPageCMS() {
  ...
  useEffect(() => {
    ...
    const fetchFormationData = async () => {
      try {
        const data = await getFormation('metodo-tf')
  ...
  const formationTitle = formationData?.title || "Desbloqueie a riqueza em sua vida"
  const formationSubtitle = formationData?.subtitle || "MÉTODO TF"
  const formationDescription = formationData?.description || "Dê um passo decisivo em direção a um futuro próspero e blindado contra as incertezas financeiras."
  const formationPrice = formationData?.price?.value ? `R$ ${formationData.price.value.toLocaleString('pt-BR')}` : "R$ 997"
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
          ...
          <ScrollAnimation animation="fadeInUp" className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-amber-600">
                {formationTitle.split(' ').slice(2, 3).join(' ')}
              </span>{" "}
              {formationTitle.split(' ').slice(3).join(' ')}
            </h1>
      ...
      {/* [Bloco 2] Stats Section - IDÊNTICO AO ORIGINAL */}
      ...
      {/* [Bloco 3] O Bloqueio Invisível - IDÊNTICO AO ORIGINAL */}
      ...
      {/* [Bloco 4] Para Quem é Indicado - IDÊNTICO AO ORIGINAL */}
      ...
      {/* [Bloco 5] Benefícios - IDÊNTICO AO ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeInUp" className="text-center mb-16">
            <Badge variant="outline" className="mb-4 px-4 py-2 border-yellow-500/50 bg-yellow-500/5">
      ...
      {/* [Bloco 6] Conteúdo do Curso - IDÊNTICO AO ORIGINAL */}
      <section className="py-20 bg-zinc-900/30">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeInUp" className="text-center mb-16">
            <Badge variant="outline" className="mb-4 px-4 py-2 border-yellow-500/50 bg-yellow-500/5">
      ...
      {/* [Bloco 7] Sobre Roberto Navarro - IDÊNTICO AO ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeIn">
      ...
      {/* [Bloco 8] Diferenciais - IDÊNTICO AO ORIGINAL */}
      <section className="py-20 bg-zinc-900/30">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeInUp" className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
      ...
      {/* [Bloco 9] Garantia - IDÊNTICO AO ORIGINAL */}
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="bg-zinc-900/90 border-2 border-yellow-500/40 rounded-3xl p-10 text-center">
              ...
              <p className="text-zinc-300 mb-6">ou 12x de R$ 97</p>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-zinc-300">
                    <li className="flex items-start gap-2">
                      ...
                      <span>1 dia de imersão presencial</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-yellow-400 mt-0.5 flex-shrink-0" />
      ...
      {/* [Bloco 10] CTA Final - IDÊNTICO AO ORIGINAL */}
      ...
      {/* [Bloco 11] FAQ - IDÊNTICO AO ORIGINAL */}
      <section className="py-20 bg-zinc-900/30">
        <div className="container mx-auto px-4">
          <ScrollAnimation animation="fadeInUp" className="text-center mb-16">
            <Badge variant="outline" className="mb-4 px-4 py-2 border-yellow-500/50 bg-yellow-500/5">
