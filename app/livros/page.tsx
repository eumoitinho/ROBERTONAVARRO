    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <p className="text-lg text-zinc-300 mb-8 max-w-xl">
          Descubra as obras de Roberto Navarro que já impactaram mais de 50 mil pessoas, trazendo prosperidade, equilíbrio e propósito.
        </p>
          ...
          {[
            {
              ...
              description: "Aprenda os princípios que diferenciam a mentalidade dos ricos e como aplicá-los para transformar sua relação com o dinheiro.",
            ...
            },
            {
              ...
              description: "Descubra como identificar e superar crenças limitantes que bloqueiam sua prosperidade financeira e pessoal.",
            ...
            },
            {
              ...
              description: "Um guia prático para investir com sabedoria, construir patrimônio e alcançar liberdade financeira.",
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <p className="text-lg text-zinc-300 mb-8 max-w-xl">
          Um divisor de águas para quem busca riqueza com propósito. Este livro revela como a mentalidade dos ricos funciona e como você pode aplicá-la na sua vida.
        </p>
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
          Baixe o E-book: <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-500">7 Passos para a Liberdade Financeira</span>
        </h2>
        <p className="text-lg text-zinc-300 mb-8 max-w-xl">
        ...
        <form className="space-y-4">
          ...
          <Button
            className="cta-hover bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-full px-8 py-6 text-base w-full"
          >
      ...
      {[
        {
          ...
          answer: "Para qualquer pessoa que deseja melhorar sua relação com o dinheiro, desde iniciantes até empreendedores experientes.",
        },
        {
          question: "O que vou aprender com essas obras?",
          answer: "Você aprenderá a desenvolver uma mentalidade rica, superar crenças limitantes e investir com inteligência para construir riqueza.",
        },
        {
        ...
        },
        {
          ...
          answer: "Os livros estão disponíveis nas principais livrarias e para compra direta pelo nosso site. Entre em contato para mais detalhes.",
        },
      ].map((faq, index) => (
        <Card
          key={index}
